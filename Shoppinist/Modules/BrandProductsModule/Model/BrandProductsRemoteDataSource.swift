//
//  BrandProductsRemoteDataSource.swift
//  Shoppinist
//
...
import Foundation
protocol BrandProductsRemoteDataSourceProtocol{
    func fetchBrandProducts(collection_id:String, compilitionHandler: @escaping (ProductModel?) -> Void)
}
class BrandProductsRemoteDataSource :BrandProductsRemoteDataSourceProtocol{
    func fetchBrandProducts(collection_id:String, compilitionHandler: @escaping (ProductModel?) -> Void) {
